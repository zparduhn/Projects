...
favoriteThings.car = "F-250";
favoriteThings.brand = "free";
...
// Create a function called MakeCard which takes in all the data it needs to make a Credit
// Card object and returns that object so that whenever you invoke MakeCard, you get a brand new credit card.

function MakeCard(number, experation){
  var ccObj = {
    ccNum: number,
    ccExper: experation
  };
...
function bindCard(person, creditcard) {
  var combined = {};
  for (var prop1 in creditcard) {
  combined[prop1] = creditCard[prop1];
  }
