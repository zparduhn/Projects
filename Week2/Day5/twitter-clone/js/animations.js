...
$(document).ready(function() {
  ...
  $('.tweet-compose').keyup(function() {
    ...
    if (len > max) {
      ...
      if (ch <= 10) {
        $('#char-count').text(ch).addClass('red');
      } else {
        $('#tweet-submit').show();
        $('#char-count').text(ch).removeClass('red');
  ...
  function newTweet(text) {
    ...
    return "<div class=\"tweet\">" +
      ...
      "<strong class=\"fullname\">Zach Parduhn</strong>" +
      "<span class=\"username\"> @zparduhn</span>" +
      ...
      "<div class=\"reply\">" +
      "<img class=\"avatar\" src=\"img/alagoon.jpg\" />" +
      "<textarea class=\"tweet-compose\" placeholder=\"Reply to @zparduhn\"/></textarea>" +
      "</div>" +
      "</div>" +
      "</div>";
